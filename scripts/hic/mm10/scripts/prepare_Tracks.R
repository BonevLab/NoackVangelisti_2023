...
if (!gtrack.exists(score_track)){
  ...
  shaman_score_hic_track(track_db=trackdb, work_dir=work_dir, score_track_nm=score_track, obs_track_nms=all_tracks,near_cis=near_cis, expand=expand_cis, k=k, max_jobs=12)
}
